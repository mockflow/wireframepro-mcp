			...
			var errorBody = {
				...
				error: {
					...
					data: {
						...
						limit: LIMIT,
						window: windowLabel,
						strategy: 'Sliding window counter, ' + LIMIT + ' visualizations per ' + windowLabel + ' per user. Only tools/call requests are counted. Wait for Retry-After seconds or spread requests evenly.'
					}
				}
			};
